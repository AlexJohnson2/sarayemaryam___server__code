    ...
    if (data.result.length != 0){
      ...
      $scope.showAlert = function() {
        var alertPopup = $ionicPopup.alert({
          ...
          template: '<p dir="rtl" style="line-height : 150%;font-size:23px;">سبد خرید و سفارشات شما به مسئول فروش در پیام رسان ایتا ارسال شد. برای انتقال به آیدی ایتای مسئول فروش روی دکمه زیر کلیک کنید.</p><a on-click="window.open("https://eitaa.com/salambarf", "_system", "location=yes"); return false;"><button class="button button-positive">انتقال به آیدی مسئول فروش</button></a>',
