    ...
    if (data.result.length != 0){
      ...
      $scope.showAlert = function() {
        var alertPopup = $ionicPopup.alert({
          ...
          template: '<p dir="rtl" style="line-height : 150%;font-size:23px;">سبد خرید و سفارشات شما به مسئول فروش در پیام رسان ایتا ارسال شد. برای انتقال به آیدی ایتای مسئول فروش روی دکمه زیر کلیک کنید.</p><a  href="#"  onclick="window.open(\'https://eitaa.com/salambarf\', \'_blank\', \'location=yes\'); alertPopup.close(); return false;"><button on-click="window.open(\'https://eitaa.com/salambarf\', \'_system\', \'location=yes\'); return false;" class="button button-positive button-block">انتقال به آیدی مسئول فروش</button></a>',
